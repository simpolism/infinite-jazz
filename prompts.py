...
class PromptBuilder:
    ...
    def build_quartet_prompt(self, previous_context: str = "") -> str:
        ...
        prompt = [
            ...
            "BASS – Anchor the harmony, but roam with passing tones or momentary melodic counterlines.",
            "DRUMS – Keep time in your own way; swing, breakbeats, or sparse commentary are all acceptable.",
            "PIANO – Shape the harmony with colors or leave space. Clustered bursts and minimal stabs are both welcome.",
            "SAX – Tell a story as the only monophonic voice. Explore contour, texture, and rhythmic surprise.",
